...
{down = iCommandPlaneAutopilot, up = iCommandPlaneStabCancel, name = _('Autopilot - Attitude/Off Switch'), category = _('SilentWarriorSwitches')},
{down = iCommandPlaneStabHbar, up = iCommandPlaneStabCancel, name = _('Autopilot - Alt/Off Switch'), category = _('SilentWarriorSwitches')},
...
{down = iCommandPlaneModeFI0, up = iCommandPlaneModeVS, name = _('Boat Switch AFT ALT - FLOOD/VertScan'), category = _('SilentWarriorSwitches')},

{down = iCommandHelicopter_PPR_button_T_up, up = iCommandHelicopter_PPR_button_T_up, value_down = 1.0, value_up = 0.0, name = _('ASC Direct Control (Cobra) Switch'), category = _('SilentWarriorSwitches')},
...
{down = iCommandPlaneFlapsOff, up = iCommandPlaneFlaps, name = 'Flaps Up/Start', category = 'SilentWarriorSwitches'},
