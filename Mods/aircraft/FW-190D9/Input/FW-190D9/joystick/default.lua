...
--Alternate flaps
{down = device_commands.Button_1, up = device_commands.Button_2, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1.0, value_up = 1.0, name = _('Alternate Flaps Up/Middle'), category = _('SilentWarriorSwitches')},
{down = device_commands.Button_3, up = device_commands.Button_2, cockpit_device_id  = devices.CONTROL_SYSTEM, value_down = 1.0, value_up = 1.0, name = _('Alternate Flaps Landing/Middle'), category = _('SilentWarriorSwitches')},
--Alternate Throttle
{down = iCommandLeftEngineStop, up = iCommandLeftEngineStart, name = _('Alternate Throttle to IDLE Start'), category = _('SilentWarriorSwitches')},
--Alternate Gunsight Power
{down = device_commands.Button_1, up = device_commands.Button_1, cockpit_device_id = devices.EZ42_GUNSIGHT, value_down = 1.0, value_up = 0.0, name = _('Alternate Gunsight Power'), category = _('SilentWarriorSwitches')},
--Alternate Master Arm
{down = device_commands.Button_3, up = device_commands.Button_3, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('Alternate Main weapon switcher'), category = _('SilentWarriorSwitches')},
--Alternate Main Rocket Switch
{down = device_commands.Button_8, up = device_commands.Button_8, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('Alternate Main Rocket Switch'), category = _('SilentWarriorSwitches')},
