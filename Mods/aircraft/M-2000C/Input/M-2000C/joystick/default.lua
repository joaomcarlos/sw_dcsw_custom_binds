...
join(res.keyCommands,{
	...
	-- SilentWarriorSwitches

	{down = 3486, up = 3486, cockpit_device_id = 11, value_down = 1, value_up = .67, name = _('Radar ON/STANDBY'), category = _('SilentWarriorSwitches')},

	{down = iCommandViewNightVisionGogglesOn, up = iCommandViewNightVisionGogglesOn, name = _('Night Vision Goggles ON/OFF'), category = _('SilentWarriorSwitches')},
	{down = iCommandViewNightVisionGogglesOn, name = _('Night Vision Goggles'), category = _('SilentWarriorSwitches')},
	{down = iCommandPlane_Helmet_Brightess_Up, name = _('Night Vision Goggles Gain Up'), category = _('SilentWarriorSwitches')},
	{down = iCommandPlane_Helmet_Brightess_Down, name = _('Night Vision Goggles Gain Down'), category = _('SilentWarriorSwitches')},

	{down = 3421, up = 3421, cockpit_device_id = 3, value_down = 1, value_up = 0, name = _('FBW Direct Control (Cobra) Switch'), category = _('SilentWarriorSwitches')},
	{down = 3421, up = 3421, cockpit_device_id = 3, value_down = 0, value_up = 1, name = _('FBW Gain NORM, else EMER'), category = _('SilentWarriorSwitches')},


	{down = iCommandPlaneRouteAutopilot, up = iCommandPlaneSAUHBarometric, name = _('Autopilot App Hold Mode, else Selected Alt Hold Mode'), category = _('SilentWarriorSwitches')},
	{down = iCommandPlaneStabHbar, up = iCommandPlaneSAUHBarometric, name = _('Autopilot Alt Hold Mode, else Selected Alt Hold Mode'), category = _('SilentWarriorSwitches')},
	{down = iCommandPlaneAirBrakeOn, up = iCommandPlaneAirBrakeOff, name = _('Airbrake ON, else OFF'), category = _('SilentWarriorSwitches')},


	{down = 3462, up = 3462, cockpit_device_id = 14, value_down = 0, value_up = .5, name = _('Slats RETRACT, else AUTO'), category = _('SilentWarriorSwitches')},
	{down = 3462, up = 3462, cockpit_device_id = 14, value_down = 1, value_up = .5, name = _('Slats EXTEND, else AUTO'), category = _('SilentWarriorSwitches')},


	{down = 3506, up = 3506, cockpit_device_id = 11, value_down = 0, value_up = .5, name = _('Radar Azimuth WIDE, else MIDDLE'), category = _('SilentWarriorSwitches')},
	{down = 3506, up = 3506, cockpit_device_id = 11, value_down = 1, value_up = .5, name = _('Radar Azimuth NARROW, else MIDDLE'), category = _('SilentWarriorSwitches')},
	{down = 3502, up = 3502, cockpit_device_id = 11, value_down = 0, value_up = .5, name = _('Radar Scan 4-LINE, else 2-LINE'), category = _('SilentWarriorSwitches')},
	{down = 3502, up = 3502, cockpit_device_id = 11, value_down = 1, value_up = .5, name = _('Radar Scan 1-LINE, else 2-LINE'), category = _('SilentWarriorSwitches')},
	{down = 3499, up = 3499, cockpit_device_id = 11, value_down = 0, value_up = 1, name = _('Radar PPI Mode, else B-Scope Mode'), category = _('SilentWarriorSwitches')},
	{down = 3205, up = 3205, cockpit_device_id = 5, value_down = 0.5, value_up = 0, name = _('Radar Altimeter ON, else OFF'), category = _('SilentWarriorSwitches')},
	{down = iCommandPlaneGearUp, up = iCommandPlaneGearDown, name = _('Landing Gear UP, else DOWN'), category = _('SilentWarriorSwitches')},
	{down = 3666, up = 3666, cockpit_device_id = 22, value_down= 1, value_up = 0, name = _('Parking Brake ON, else OFF'), category = _('SilentWarriorSwitches')},
	...
	--D2M
	{down = 3608, up = 3608, cockpit_device_id = 13, value_down = 0,   name = _('D2M OFF'),  category = _('Sensors')},
    {down = 3608, up = 3608, cockpit_device_id = 13, value_down = 0.5, name = _('D2M ON'),   category = _('Sensors')},
    {down = 3608, up = 3608, cockpit_device_id = 13, value_down = 1,   name = _('D2M TEST'), category = _('Sensors')},
